...
R_t & = & \frac{p_t}{\beta},
\end{eqnarray*}
where we are again using the normalization $E_{t-1} p_t = 1$.\footnote{We  remind the reader of  the convention  that we set  $R_{0}=\beta^{-1} p_0$.} Substituting these into the  budget constraint \eqref{agent bc affine} gives %, the implementability constraints become
