...
\textbf{Anmol XXXXX:
I edited your sentence.  We might have to iterate.}
...
the second and third questions posed in our first paragraph of this paper are interesting only in settings in which
 ...
 transfersd, at least he does  when he cares enough about poorer agents.  
...
\begin{proof}
The FOCs together with the envelope theorem imply that $\mathbb{E}P(s)V'(b(s))=V'(b\_)+\mathbb{E}P(s)\bar{\kappa}-\mathbb{E}P(s)\underline{\kappa}$
