...
These agents stand in for  the $90\textsuperscript{th},75\textsuperscript{th},50\textsuperscript{th},25\textsuperscript{th},  \text{and } 10\textsuperscript{th}$ percentiles
of the  US wage distribution, respectively. 


We assume i.i.d aggregate shocks $\epsilon_t$ that affect both the labor productivities of all agents $\{\theta_{i,t}\}^{N}_{i=1}$ and the  payoff $p_t$ of the single asset as follows:
\begin{subequations}
\begin{equation*}
