...
then the government will want to run up  debt.  %; if the return on the asset is low, the government accumulates debt and in the other case when returns on the asset are high, it accumulates assets.
